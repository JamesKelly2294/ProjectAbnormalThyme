...
public class TrackPathManager : MonoBehaviour
{
    ...
    Vector3[] localBeginWaypoints = new[] { new Vector3(-1.431539f, -1.062f, 0f), new Vector3(0.038f, -0.4f, 0f) };
        ...
        foreach (RollerCoasterTrack track in tracks) {
            ...
            switch (track.type)
            {
                ...
                case RollerCoasterTrackType.Straight:
                    ...
                    break;
                case RollerCoasterTrackType.Begin:
                    localWaypoints = new List<Vector3>(localBeginWaypoints);
                    break;
                case RollerCoasterTrackType.End:
